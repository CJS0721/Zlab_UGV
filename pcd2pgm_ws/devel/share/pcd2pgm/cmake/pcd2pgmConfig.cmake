...
if("TRUE" STREQUAL "TRUE")
  set(pcd2pgm_SOURCE_PREFIX /home/robot/pcd2pgm_ws/src/pcd2pgm_package-develop/pcd2pgm)
  set(pcd2pgm_DEVEL_PREFIX /home/robot/pcd2pgm_ws/devel)
  set(pcd2pgm_INSTALL_PREFIX "")
  set(pcd2pgm_PREFIX ${pcd2pgm_DEVEL_PREFIX})
else()
  set(pcd2pgm_SOURCE_PREFIX "")
  set(pcd2pgm_DEVEL_PREFIX "")
  set(pcd2pgm_INSTALL_PREFIX /home/robot/pcd2pgm_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcd2pgm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/pcd2pgm_ws/src/pcd2pgm_package-develop/pcd2pgm/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND pcd2pgm_EXPORTED_TARGETS ${${pcd2pgm_dep}_EXPORTED_TARGETS})
endforeach()
